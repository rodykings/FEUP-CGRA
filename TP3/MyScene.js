...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.67, 0.41, 0.22, 0.5);
        this.material4.setDiffuse(0.67, 0.41, 0.22, 0.26);
        this.material4.setSpecular(0.76, 0.53, 0.20, 0.30);
        this.material4.setShininess(3.0);
