class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/yellowtopbluedown.vert", "shaders/yellowtopbluedown.frag"),
			new CGFshader(this.gl, "shaders/yellowtopbluedown.vert", "shaders/grayscale.frag"),
		...
		this.shadersList = {
			...
			'Convolution': 8,
			'YellowTopBlueDown': 9,
			'YellowTopBlueDown Grayscale': 10,
			'Water': 11
		};
